...
public class ResponseCodeEvaluator {
    ...
    private static String getResponse(Context context, int category, int number) {
        ...
        switch (choice) {
            case 10:
                response = context.getString(R.string.rc_1xx);
                break;
            case 11:
                response = context.getString(R.string.rc_1xx_2);
                break;
            case 12:
                response = context.getString(R.string.rc_1xx_3);
                break;
            case 13:
                response = context.getString(R.string.rc_1xx_4);
                break;

            case 20:
                response = context.getString(R.string.rc_2xx);
                break;
            case 21:
                response = context.getString(R.string.rc_2xx_2);
                break;
            case 22:
                response = context.getString(R.string.rc_2xx_3);
                break;
            case 23:
                response = context.getString(R.string.rc_2xx_4);
                break;
            case 24:
                response = context.getString(R.string.rc_2xx_5);
                break;

            case 30:
                response = context.getString(R.string.rc_3xx);
                break;
            case 31:
                response = context.getString(R.string.rc_3xx_2);
                break;
            case 32:
                response = context.getString(R.string.rc_3xx_3);
                break;
            case 33:
                response = context.getString(R.string.rc_3xx_4);
                break;

            case 40:
                response = context.getString(R.string.rc_4xx);
                break;
            case 41:
                response = context.getString(R.string.rc_4xx_2);
                break;
            case 42:
                response = context.getString(R.string.rc_4xx_3);
                break;
            case 43:
                response = context.getString(R.string.rc_4xx_4);
                break;
            case 44:
                response = context.getString(R.string.rc_4xx_5);
                break;
            case 45:
                response = context.getString(R.string.rc_4xx_6);
                break;

            case 50:
                response = context.getString(R.string.rc_5xx);
                break;
            case 51:
                response = context.getString(R.string.rc_5xx_2);
                break;
            case 52:
                response = context.getString(R.string.rc_5xx_3);
                break;
            case 53:
                response = context.getString(R.string.rc_5xx_4);
                break;
            case 54:
                response = context.getString(R.string.rc_5xx_5);
                break;

            case 0:
                response = context.getString(R.string.rc_nix);
                break;
            case 1:
                response = context.getString(R.string.rc_nix_2);
                break;
            case 2:
                response = context.getString(R.string.rc_nix_3);
                break;
            case 3:
                response = context.getString(R.string.rc_nix_4);
                break;
            case 4:
                response = context.getString(R.string.rc_nix_5);
                break;
        }
        return response;
    }
